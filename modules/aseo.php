    ...
    <div class="tabla_m text-center">
        <table class="table">
            ...
            <tbody>
                <?php
        if ($_SESSION['rl'] == 2) {
            $result2 = mysqli_query($con, "SELECT * FROM serviciosc WHERE tipo_servs = 'aseo' and fk_user = '$numero'") or die("Error en la consulta de servicio autos");
        } elseif ($_SESSION['rl'] == 1) {
            $result2 = mysqli_query($con, "SELECT * FROM serviciosc WHERE tipo_servs = 'aseo'");
        }
                            ...
                            <div class="modal-body">
                                <form method="post" action="dashboard.php?mod=aseo" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-success" name="btn_actualizar2">Actualizar
                                            servicios</button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form method="post" action="dashboard.php?mod=aseo">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-danger"
                                            name="btn_eliminar2">Eliminar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
